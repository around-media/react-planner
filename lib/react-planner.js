...
var ReactPlanner = function (_Component) {
  ...
  _createClass(ReactPlanner, [{
    ...
    value: function render() {
      ...
      var content = _react2.default.createElement(_export3.Content, _extends({
        width: contentW,
        height: contentH,
      ...
      if (CustomUI) {
        contentW = width;
        contentH = height;
        planner = _react2.default.createElement(
          _react.Fragment,
          null,
          _react2.default.createElement(CustomUI, _extends({ state: extractedState }, props)),
          content
        );
      } else {
        planner = _react2.default.createElement(
...
ReactPlanner.propTypes = {
  translator: (0, _propTypes.instanceOf)(_translator2.default),
  catalog: (0, _propTypes.instanceOf)(_catalog2.default),
  allowProjectFileSupport: _propTypes.bool,
  plugins: (0, _propTypes.arrayOf)(_propTypes.func),
  autosaveKey: _propTypes.string,
  autosaveDelay: _propTypes.number,
  width: _propTypes.number.isRequired,
  height: _propTypes.number.isRequired,
  stateExtractor: _propTypes.func.isRequired,
  toolbarButtons: _propTypes.array,
  sidebarComponents: _propTypes.array,
  footerbarComponents: _propTypes.array,
  customContents: _propTypes.object,
  softwareSignature: _propTypes.string,
  CustomUI: (0, _propTypes.oneOfType)(_propTypes.element, _propTypes.func),
...
ReactPlanner.childContextTypes = _extends({}, (0, _objectsUtils.objectsMap)(_export2.default, function () {
  ...
  translator: _propTypes.object,
  catalog: _propTypes.object
});
