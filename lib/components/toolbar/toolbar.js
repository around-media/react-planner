  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      var sorter = [{
        ...
        index: 2,
        condition: allowProjectFileSupport,
        dom: _react2.default.createElement(_toolbarExportButton2.default, {
          state: state,
...
Toolbar.propTypes = {
  ...
  allowProjectFileSupport: _propTypes.bool.isRequired,
  toolbarButtons: _propTypes.array
};

Toolbar.contextTypes = {
  projectActions: _propTypes.object.isRequired,
  viewer2DActions: _propTypes.object.isRequired,
  viewer3DActions: _propTypes.object.isRequired,
  linesActions: _propTypes.object.isRequired,
  holesActions: _propTypes.object.isRequired,
  itemsActions: _propTypes.object.isRequired,
